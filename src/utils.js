/**
 * VROOM.PT - Event Image Logic
 * Replicated from Dart code.
 */

export function getEventImage(id, category, circuit, imagemEvento, veiculoAlvo) {
  ...
  if (veiculo === "Motas") {
    ...
    if (circ.includes("ESTORIL")) {
      ...
      imageFiles = ['drag_1.jpg', 'drag_2.jpg', 'drag_3.jpg'];
